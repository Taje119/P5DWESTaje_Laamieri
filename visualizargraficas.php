...
<body>
    ...
    <nav class="menu">
        <div class="contenedor">
            ...
            <a href="visualizartablas.php">Visualizar Tablas</a>
            <a href="visualizargraficas.php" class="activo">Visualizar Gráficas</a>
    ...
    <main class="contenedor">
        <section class="bloque">
            <h2>Gráficas de resultados obtenidos</h2>
            <p>En esta página se mostrarán todas las gráficas del proyecto.</p>

            <div id="zona-graficas" class="zona-resultados">
                Cargando gráficas...
            </div>
        </section>
    </main>
